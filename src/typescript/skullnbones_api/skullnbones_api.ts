...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    trades = {
        ...
        /**
         * @description Get last trade from SYMBOL Responses with a last trade for a given symbol. [default 10]
         *
         * @tags trades
         * @name GetSymbol
         * @summary Get last trade from SYMBOL
         * @request GET:/trades/symbol
         */
        getSymbol: (
            query: {
                /** @example "FOODATLAS" */
